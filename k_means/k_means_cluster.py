...
print "The minimum value taken by exercised_stock_options is", \
    min([person[feature] for person in data_dict.values() if person[feature] != 'NaN'])

print "The maximum value taken by exercised_stock_options is", \
    max([person[feature] for person in data_dict.values() if person[feature] != 'NaN'])

feature = "salary"
print "The minimum value taken by salary is", \
    min([person[feature] for person in data_dict.values() if person[feature] != 'NaN'])
